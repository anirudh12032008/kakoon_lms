# umqtt.simple wrapper — install as umqtt/simple.py on your ESP32
# This file is the same as umqtt/simple.py
...
class MQTTClient:
    ...
    def connect(self, clean_session=True):
        ...
        i = 1
        while sz > 0x7f:
            premsg[i] = (sz & 0x7f) | 0x80; sz >>= 7; i += 1
        premsg[i] = sz
        ...
        if resp[3] != 0: raise MQTTException(resp[3])
        return resp[2] & 1
